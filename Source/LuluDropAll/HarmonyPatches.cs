...
namespace LoonyLadle.DropAll
{
    ...
    static class HarmonyPatches
    {
        ...
        {
            var harmony = HarmonyInstance.Create("rimworld.loonyladle.dropall");
            harmony.PatchAll();
        }
    }
    ...
    public static class HarmonyPatch_Pawn_GetGizmos
    {
        public static IEnumerable<Gizmo> Postfix(IEnumerable<Gizmo> gizmos, Pawn __instance)
        {
            ...
            if (__instance.Spawned && __instance.MentalState == null && __instance.HostFaction == null && (__instance.Faction?.IsPlayer ?? false) && (__instance.inventory?.innerContainer?.Any ?? false))
            {
